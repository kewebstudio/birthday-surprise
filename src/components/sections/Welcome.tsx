  ...
  Clara
        ...
        >
          <p className="text-sm leading-7 text-gray-700">
            Someone has prepared a beautiful birthday journey filled with
            love, joyful memories, heartfelt wishes and magical surprises,
        ...
        <div className="mt-4 w-full max-w-sm">
          <NextButton
            title="🎁 TAP HERE TO OPEN YOUR SURPRISE"
            onClick={onNext}
          />
        </div>
